    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('measurement_unit', models.CharField(blank=True, max_length=100, null=True, verbose_name='Единица измерения')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('ingredient', models.ManyToManyField(related_name='ingredient_in_recipe', to='recipes.ingredient', verbose_name='Ингредиент')),
                ('recipe', models.ManyToManyField(related_name='recipe_ingredient', to='recipes.recipe', verbose_name='Рецепт')),
            ],
            options={
